...
type CmsOrder struct {
	OrderId                   string    `xorm:"not null pk index VARCHAR(20)" json:"orderId,omitempty" xml:"orderId"`
	...
	WarehouseCode             string    `xorm:"default '1' VARCHAR(100)" json:"warehouseCode,omitempty" xml:"warehouseCode"`
	...
	OrderApproved             int       `xorm:"default 0 INT" json:"orderApproved,omitempty" xml:"orderApproved"`

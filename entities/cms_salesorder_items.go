...
type CmsSalesOrderItems struct {
	OrderItemId         uint64    `xorm:"pk autoincr unique(unx) UNSIGNED BIGINT" json:"orderItemId,omitempty" xml:"orderItemId"`
...
func (m *CmsSalesOrderItems) TableName() string {
	return "cms_salesorder_details"
}

...
type CmsInvoiceDetails struct {
	Id           uint64    `xorm:"pk autoincr unique(invoice_code) UNSIGNED BIGINT" json:"id,omitempty" xml:"id"`
	...
	RefNo        string    `xorm:"unique(invoice_code) index VARCHAR(80)" json:"refNo,omitempty" xml:"refNo"`

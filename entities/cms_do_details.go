...
type CmsDoDetails struct {
	Id                  uint64    `xorm:"pk autoincr unique(do_code) UNSIGNED BIGINT" json:"id,omitempty" xml:"id"`
	...
	RefNo               string    `xorm:"comment('dtlkey') unique(do_code) index VARCHAR(80)" json:"refNo,omitempty" xml:"refNo"`

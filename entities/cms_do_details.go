...
type CmsDoDetails struct {
	...
	DoCode              string    `xorm:"not null default '' unique(do_code) VARCHAR(50)" json:"doCode,omitempty" xml:"doCode"`
	...
	RefNo               string    `xorm:"comment('dtlkey') unique(do_code) index VARCHAR(50)" json:"refNo,omitempty" xml:"refNo"`

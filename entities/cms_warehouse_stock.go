...
type CmsWarehouseStock struct {
	...
	ProductCode    string    `xorm:"not null unique(unq) VARCHAR(200) index" json:"productCode,omitempty" xml:"productCode"`
	WhCode         string    `xorm:"not null unique(unq) VARCHAR(200) index" json:"whCode,omitempty" xml:"whCode"`

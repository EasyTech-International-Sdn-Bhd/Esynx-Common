...
type CmsAppAdvertisement struct {
	Id           uint64    `xorm:"pk autoincr unique(advercode) UNSIGNED BIGINT" json:"id,omitempty" xml:"id"`
	AdverCode    string    `xorm:"default '' unique(advercode) VARCHAR(50)" json:"adverCode,omitempty" xml:"adverCode"`

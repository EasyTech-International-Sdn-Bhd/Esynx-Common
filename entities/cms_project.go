...
type CmsProject struct {
	Id             uint64  `xorm:"pk autoincr unique(pjCode) UNSIGNED BIGINT" json:"id,omitempty" xml:"id"`
	ProjectCode    string  `xorm:"unique(pjCode) VARCHAR(200)" json:"projectCode,omitempty" xml:"projectCode"`
